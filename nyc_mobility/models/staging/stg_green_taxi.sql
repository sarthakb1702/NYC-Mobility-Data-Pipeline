...
WITH cleaned AS (
    ...
    SELECT
        ...
        COALESCE(t.PAYMENT_TYPE, 6) AS payment_type_id,
        ...
        CASE
            WHEN t.TRIP_TYPE = 1 THEN 'Street-Hail'
            WHEN t.TRIP_TYPE = 2 THEN 'Dispatch'
            ELSE 'Unknown'
        END AS trip_type,
        ...
        COALESCE(t.EHAIL_FEE, 0) AS ehail_fee,
        ...
        CASE
            WHEN t.LPEP_DROPOFF_DATETIME <= t.LPEP_PICKUP_DATETIME
            THEN TRUE
            ELSE FALSE
    ...
    FROM {{ source('raw', 'green_taxi_raw') }} t
    ...
    WHERE
        t.LPEP_PICKUP_DATETIME IS NOT NULL
